          ...
          >
            <div className="relative">
              <div className="w-full h-80 md:h-96 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
                <img
                  src="/kvs.svg?height=400&width=600"
                  alt="Karan Singh"
